...
class MedianFilter:
    ...
    def __init__(self):
        """
        Usage  : The constructor of MedianFilter Class.
        Inputs : Nothing.
        Returns: An instantiation of MedianFilter Class.
        """
...
def meidan_filter_apply(image, kernel_size, border_type = "constant"):
    """
