...
class Closing:
    """
    Use this class to perform closing operation on an image.
    """
    def __init__(self):
    ...
    def config(self, **kwargs) -> None:
        """
        Usage: Use this method to configure the parameters of the closing instantiation.
    ...
    def apply(self, image: np.ndarray) -> np.ndarray:
        """
        Usage: Use this method to apply closing operation on your image.

        Inputs:
            image: The closing operation would be applied on this image.

        Returns:
            - the image with closing operation applied on it.
        """
...
def closing_apply(image: np.ndarray, kernel_size: int = 3, degree: int = 1, border_type: str = "constant") -> np.ndarray:
    """
    Usage: Use this function to apply closing operation on your image.
